...
export default function Faq() {
  return (
    <div className="flex items-center justify-center bg-primary px-8 py-24 text-white">
      <BlockInTextCard
        tag="/ Support"
        text={
          <>
...
const BlockInTextCard = ({
  ...
  return (
    <div className="w-full max-w-5xl space-y-6">
      ...
      <button className="w-full rounded-full border border-light  py-2 text-sm font-medium transition-colors hover:bg-neutral-950 hover:text-neutral-100">
        Contact Support
      </button>
    </div>
  );
